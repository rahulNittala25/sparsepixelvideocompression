...
class SpectralConvLSTMCell(nn.Module):
    """
    Basic CLSTM cell.
    """
    ...
    def __init__(self, in_channels, hidden_channels, kernel_size, bias):
        ...
        #super(SpectralConvLSTMCell, self).__init__()
        super().__init__()
        ...
        self.conv = SpectralNorm(nn.Conv2d(in_channels=self.input_dim + self.hidden_dim,
...
class SpectralConvLSTM(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, kernel_size, num_layers,
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(SpectralConvLSTMCell(in_channels=cur_input_dim,
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        # Implement stateful SpectralConvLSTM
...
class SpectralConvBLSTM(nn.Module):
    # Constructor
    def __init__(self, in_channels, hidden_channels,
                 kernel_size, num_layers, bias=True, batch_first=False):

        super(SpectralConvBLSTM, self).__init__()
        self.forward_net = SpectralConvLSTM(in_channels, hidden_channels//2, kernel_size,
                                    num_layers, batch_first=batch_first, bias=bias)
        self.reverse_net = SpectralConvLSTM(in_channels, hidden_channels//2, kernel_size,
                                    num_layers, batch_first=batch_first, bias=bias)
