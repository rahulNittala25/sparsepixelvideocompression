    ...
    def train(self):
        ...
        for step in range(start, self.total_step):
            ...
            for i in range(self.d_iters):
                ...
                seed1 = torch.rand((b,t,c,h,w)).cuda()
                ...
                seed2 = torch.rand((b,t,c,h,w)).cuda()
                ...
                if(step%1==0):
                    ...
                    #print("Real DS_Loss:"+str(ds_loss_real.item())+"Fake DS_Loss:"+str(ds_loss_fake.item()))
                    if step%200 ==0:
                ...
                g_loss = ds_loss_fake + dt_loss_fake + 10*mse_loss + d_loss
